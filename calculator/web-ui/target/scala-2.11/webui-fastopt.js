...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(expr, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())), references)
});
$c_Lcalculator_Calculator$.prototype.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D = (function(expr, used, references$1) {
  _helper: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a, used, references$1) + this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b, used, references$1))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$2, used, references$1) - this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$2, used, references$1))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$3, used, references$1) * this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$3, used, references$1))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(a$4, used, references$1) / this.helper$1__p1__Lcalculator_Expr__sci_Set__sci_Map__D(b$4, used, references$1))
    } else {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((d < 0)) {
        ...
        var b2 = $uD(b$2.apply__O());
        var a2 = $uD(a$2.apply__O());
        var array = [(((-b2) + $uD($g["Math"]["sqrt"](d))) / (2 * a2)), (((-b2) - $uD($g["Math"]["sqrt"](d))) / (2 * a2))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      ...
      return ((r < 0) ? "red" : ((r < 15) ? "orange" : "green"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(e) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, e$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(e$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, e));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
